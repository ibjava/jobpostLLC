 ...
 */
// function et_register_menu_setting(){
// 	// register payment menu item
// 	et_register_menu_section('ET_MenuSettings');
// 	et_register_menu_section('ET_MenuPayment');
// }
// add_action('et_admin_menu', 'et_register_menu_setting');
...
function et_update_mail_template () {
	...
	if( $mail_opt->update_mail_template ($mail, $value) ){
