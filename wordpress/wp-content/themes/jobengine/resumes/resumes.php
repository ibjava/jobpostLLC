...
class JE_Resume extends ET_Base{
    ...
    static public function insert($args){
        ...
        $args['et_location']        =   get_user_meta( $current_user->ID, 'et_location' , true );
        // setup field
        $fields = array();
    ...
    static function confidential_resume ($arr) {
        ...
        */
        ...
        $arr    =   apply_filters( 'conver_confidential_user', $arr );
    ...
    static function public_resume ($arr) {
        ...
        $arr    =   apply_filters( 'conver_public_user', $arr );
        return $arr;
    }
...
class JE_Resume_Ajax extends ET_Base{
    ...
    */
    ...
    public function resume_apply() {
        ...
        try {
            ...
            if (!is_wp_error( $app ) && is_numeric($app)){
                $this->send_application_mail($args);
    ...
    private function send_application_mail($args, $template_args = array()){
        $job            = get_post($args['job_id']);
        ...
        */
        ...
        wp_mail( $mail_to_company['to'], $mail_to_company['subject'], $mail_to_company['message'], $mail_to_company['headers'] );
