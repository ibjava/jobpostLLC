...
class JE_Resume_Front extends JE_Resume_Init{
	...
	public function on_add_scripts () {
		...
		wp_localize_script( 'et_resume', 'et_resume', array(
			...
			'date_range_invalid' => __("Begining date must after to finish date", ET_DOMAIN),
		...
		else if (is_post_type_archive('resume')){
	...
	*/
	...
	public function wp_footer_add_template () {
		...
		if( is_singular( 'resume' ) || is_page_template('page-jobseeker-signup.php') || is_archive('resume')) {
