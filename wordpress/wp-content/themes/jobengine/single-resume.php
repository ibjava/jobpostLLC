	...
	<div  class="main-center clearfix padding-top30 jse-profile <?php if ($authorise) echo 'authorized' ?>">
		...
		?>
			...
			<div class="module send-message">
				<div class="title"><?php printf(__("Message %s"), $jobseeker->display_name); ?></div>				
				<?php 
				$sender = array(
					...
					<div class="jse-message">
						...
						<div class="jse-input">
							...
							<div class="inner input-area">
								<input type="text" class="bg-default-input" name="sender_name" value="<?php echo $sender['name'] ?>" />
							</div>
						</div>
						<div class="jse-input">
							<label><?php _e('Email address', ET_DOMAIN) ?></label>
							<div class="inner input-area">
								<input type="text" class="bg-default-input" name="sender_email" value="<?php echo $sender['email'] ?>"/>
							</div>
						</div>
