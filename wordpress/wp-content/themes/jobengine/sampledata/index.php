...
?>
	...
	<?php 
			if(is_active_sidebar('sidebar-blog-listing-home-top')) { ?>
				<div class="sidebar-home-top <?php if(current_user_can('manage_options') ) echo 'sortable' ?>" id="sidebar-blog-listing-home-top" >
					<?php 
						dynamic_sidebar('sidebar-blog-listing-home-top');
    ...
    <?php get_sidebar () ?>
		...
		<div id="latest_jobs_container">
			...
			<div class="button-more" <?php if ( $wp_query->max_num_pages <= 1 ) { echo 'style="display:none"'; }?>>
