...
function et_layout_classes( $existing_classes ) {
	...
	// if(is_singular( 'resume' ) || is_post_type_archive( 'resume' ) || is_page_template('page-jobseeker-signup.php') || is_page_template('page-upgrade-account.php')) {
	// 	$classes[] = 'margin-top-70';
	// }

	// if( is_singular( 'post' ) || is_post_type_archive( 'post' ) || is_category() || is_date() ) {
	// 	$classes[] = 'margin-top-70';
	// }
