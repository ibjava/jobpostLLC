...
function et_schedule_events(){
	// echo date('Y-m-d h:i:s', current_time('timestamp') ); echo '<br/>';
	// echo date('Y-m-d h:i:s', wp_next_scheduled('archive_expired_jobs_2') );
...
function et_expired_jobs_count(){
	...
	$archived_jobs = $wpdb->get_results($sql);
	// echo date('Y-m-d h:i:s', current_time('timestamp') ); echo '<br/>';
	// echo date('Y-m-d h:i:s', wp_next_scheduled('archive_expired_jobs') );
	// foreach ($archived_jobs as $job) { 
	// 	echo get_post_meta( $job->ID, 'et_expired_date', true ); echo ' '; echo get_post_meta( $job->ID, 'et_template_id', true );
	// 	echo get_the_title ($job->ID);
	// 	echo '<br/>';
	// }
